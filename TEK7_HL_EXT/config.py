...
parser.add_argument('--dataroot', default=r'C:\Users\KIM\Documents\PROGRAPHY DATA_ver3', help='path to dataset')
...
parser.add_argument('--lr', type=float, default=0.0012, help='learning rate, default=0.001')

parser.add_argument('--beta1', type=float, default=0.9, help='beta1 for adam. default=0.9')
parser.add_argument('--beta2', type=float, default=0.999, help='beta2 for adam. default=0.999')
parser.add_argument('--weight_decay', type=float, default=0.0003, help='weight_decay for adam. default=0')
